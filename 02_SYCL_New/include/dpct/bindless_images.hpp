...
create_bindless_image(image_data data, sampling_info info,
  ...
  //cout<<"info.get_addressing_mode()"<<info.get_addressing_mode()
//cout<<"info.get_coordinate_normalization_mode()"<<info.get_coordinate_normalization_mode()
//cout<<"info.get_filtering_mode()"<<info.get_filtering_mode()<<"info.get_mipmap_filtering()"<<info.get_mipmap_filtering()<<"info.get_min_mipmap_level_clamp()"<<info.get_min_mipmap_level_clamp()<<"info.get_max_anisotropy()"<<info.get_max_anisotropy()<<endl;
  ...
  //cout<<"data.get_data_type()"<<data.get_data_type()<<endl;
  ...
  cout<<"In image_data_type::pitch case"<<endl;
#ifdef DPCT_USM_LEVEL_NONE
    auto mem =
    ...
    q.ext_oneapi_copy(
        ...
        .wait();
#else
	cout<<"data.get_x()"<<data.get_x()<<"data.get_y()"<<data.get_y()<<"data.get_channel().get_channel_num()"<<data.get_channel().get_channel_num()<<endl;
	//"data.get_channel_type()"<<data.get_channel_type()<<endl;
    ...
    cout<<"After image des"<<endl;
    std::cout << "Data pointer: " << data.get_data_ptr() << std::endl;
    std::cout << "Pitch: " << data.get_pitch() << std::endl;
